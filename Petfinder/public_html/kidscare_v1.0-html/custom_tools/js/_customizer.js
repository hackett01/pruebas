...
custom_options  +=											'<input type="hidden" name="co_theme_color" value="#1bb4b9"/>';
custom_options  +=											'<span class="co_label one_row">Main:</span>';
custom_options  +=											'<div id="co_theme_color" class="iColorPicker">';
custom_options  +=											'</div>';
custom_options  +=											'<input type="hidden" name="co_menu_color" value="#e33c1c"/>';
custom_options  +=											'<span class="co_label one_row">Menu:</span>';
custom_options  +=											'<div id="co_menu_color" class="iColorPicker">';
custom_options  +=											'</div>';
custom_options  +=											'<input type="hidden" name="co_user_menu_color" value="#191d1e"/>';
custom_options  +=											'<span class="co_label one_row">User:</span>';
custom_options  +=											'<div id="co_user_menu_color" class="iColorPicker" style="margin-right:0;"></div>';
custom_options  +=										'</div>';
custom_options  +=									'</div>';
custom_options  +=									'<div class="co_form_row">';
...
custom_options  +=									'</li>';
custom_options  +=									'<li>';
custom_options  +=										'<a href="#">May 2014</a>&nbsp;(4)';
custom_options  +=									'</li>';
custom_options  +=									'<li>';
...
custom_options  +=										'<a href="features-pages-about-us.html">About Us</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="features-pages-contact-us.html">Contact Us</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="features-pages-donation.html">Donation</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="features-pages-faq.html">FAQ</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="index.html">Homepage (Babysitter)</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="headers-central-menu.html">Homepage (Babysitter) Central menu</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="headers-standard.html">Homepage (Babysitter) Standard</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="headers-transparent.html">Homepage (Babysitter) Transparent</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="index2.html">Homepage (Health Care)</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="index3.html">Homepage (Learn &#038; Play)</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="index4.html">Homepage (Toys Store)</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="headers-video.html">Homepage with Video Background (Babysitter)</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="features-tools-pricing-tables.html">Pricing Tables</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="features-tools-typography.html">Typography</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="page_item">';
custom_options  +=										'<a href="features-pages-under-constraction.html">Under Constraction</a>';
custom_options  +=									'</li>';
custom_options  +=								'</ul>';
custom_options  +=							'</aside>';
...
custom_options  +=										'on';
custom_options  +=										'<a href="#">Little Known on How to Best Help Kids After Trauma</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="recentcomments">';
custom_options  +=										'<span class="comment-author-link">John Doe</span>';
custom_options  +=										'on';
custom_options  +=										'<a href="#">Babysitter and Nanny Hiring Resources</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="recentcomments">';
custom_options  +=										'<span class="comment-author-link">John Doe</span>';
custom_options  +=										'on';
custom_options  +=										'<a href="#">Quote post</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="recentcomments">';
custom_options  +=										'<span class="comment-author-link">Miki Williams</span>';
custom_options  +=										'on';
custom_options  +=										'<a href="#">Link post</a>';
custom_options  +=									'</li>';
custom_options  +=									'<li class="recentcomments">';
custom_options  +=										'<span class="comment-author-link">Miki Williams</span>';
custom_options  +=										'on';
custom_options  +=										'<a href="#">Theme Slider instead of Gallery</a>';
custom_options  +=									'</li>';
custom_options  +=								'</ul>';
custom_options  +=							'</aside>';
custom_options  +=						'</div>';
...
custom_options  +=									'<a href="index4.html">E-Commerce</a>';
custom_options  +=								'</li>';
custom_options  +=								'<li class="menu-item">';
custom_options  +=									'<a href="#">Events Calendar</a>';
custom_options  +=								'</li>';
custom_options  +=								'<li class="menu-item menu-item-has-children">';
custom_options  +=									'<a href="#">Sliders</a>';
custom_options  +=									'<ul class="sub-menu">';
custom_options  +=										'<li class="menu-item">';
custom_options  +=											'<a href="#">Posts Slider Fullscreen</a>';
custom_options  +=										'</li>';
custom_options  +=									'</ul>';
custom_options  +=								'</li>';
custom_options  +=							'</ul>';
...
jQuery(document).ready(function() {
	...
	jQuery('#co_theme_color').css('backgroundColor', '#1bb4b9');
